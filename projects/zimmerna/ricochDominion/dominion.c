...
int cardEffect(int card, int choice1, int choice2, int choice3, struct gameState *state, int handPos, int *bonus)
{
  ...
  switch( card )
    {
    case adventurer:
      adventurerEffect(currentPlayer, state, cardDrawn, drawnTreasure, temphand);
      return 0;
    ...
    case sea_hag:
      sea_hagEffect(currentPlayer, state);
      return 0;
...
//smithy refactored out of switch statement in cardEffect
...
//adventurer refactored out of switch statement in cardEffect
void adventurerEffect(int currentPlayer, struct gameState *state, int cardDrawn, int drawnTreasure, int *temphand)
{
  ...
  while(drawnTreasure)
  {
    ...
    drawCard(currentPlayer, state);
    cardDrawn = state->hand[state->handCount[currentPlayer]-1][currentPlayer];//top card of hand is most recently drawn card.
...
//gardens refactored out of switch statement in cardEffect
int gardensEffect()
{
  return -1;
}

//tribute refactored out of switch statement in cardEffect
...
//seahag refactored out of switch statement in cardEffect
void sea_hagEffect(int currentPlayer, struct gameState *state)
{
  int i = 0;
  for (i = 0; i < state->numPlayers; i++)
  {
